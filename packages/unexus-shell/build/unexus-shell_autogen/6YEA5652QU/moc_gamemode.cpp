...
namespace {
struct qt_meta_tag_ZN8GameModeE_t {};
} // unnamed namespace

template <> constexpr inline auto GameMode::qt_create_metaobjectdata<qt_meta_tag_ZN8GameModeE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<GameMode, qt_meta_tag_ZN8GameModeE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject GameMode::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8GameModeE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8GameModeE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN8GameModeE_t>.metaTypes,
    nullptr
} };
...
void GameMode::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (GameMode::*)()>(_a, &GameMode::activeChanged, 0))
            return;
    }
...
void *GameMode::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN8GameModeE_t>.strings))
